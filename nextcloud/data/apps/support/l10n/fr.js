OC.L10N.register(
    ...
    "If you encounter a problem and your server does no longer work, blocking employees from sharing or customers from downloading and uploading files, you don't have to rely on searching online and asking volunteers on forums and social media for a solution. You have direct access to our experienced engineers who help you track down and fix the problem." : "Si vous rencontrez un problème et que votre serveur ne fonctionne plus, empêchant les employés de partager ou les clients de télécharger et de téléverser des fichiers, vous n'avez pas besoin de chercher en ligne et de demander aux bénévoles sur les forums et les médias sociaux de trouver une solution. Vous avez un accès direct à nos ingénieurs expérimentés qui vous aident à localiser et à résoudre le problème.",
    "You have a contract with the vendor providing confidential security information, mitigations, patches and updates." : "Vous avez un contrat avec le fournisseur qui fournit des renseignements confidentiels sur la sécurité, des mesures d'atténuation, des correctifs et des mises à jour.",
    "If you want to skip a release or two and stay a bit longer on your current version without disruptions, you don't have to run software without security updates. We deliver them to you as long as is needed!" : "Si vous voulez sauter une ou deux versions et rester un peu plus longtemps sur votre version actuelle sans interruption, vous n'avez pas besoin d'exécuter le logiciel sans mises à jour de sécurité. Nous vous les livrons aussi longtemps que nécessaire !",
    "If you have performance and scalability issues you have the best expertise at hand, instead of having to search on the web and hope you find a solution." : "Si vous avez des problèmes de performance et d'évolutivité, vous avez la meilleure expertise à portée de main, au lieu d'avoir à chercher sur le web et d'espérer trouver une solution.",
    "If you are asked how the compliance of Nextcloud is and if you can deliver a data export under GDPR, HIPAA or other rules, you have access to the right documentation and can tap into our expertise to respond quickly and accurately." : "Si on vous demande comment est la conformité de Nextcloud et si vous pouvez fournir une exportation de données sous RGPD, HIPAA ou d'autres règles, vous avez accès à la bonne documentation et pouvez puiser dans notre expertise pour répondre rapidement et précisément.",
    "We can also provide you Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a very limited form for free. And we can develop further integrations and capabilities you need." : "Nous pouvons également vous fournir l'intégration d'Outlook, la suite Office en ligne, l'audio-vidéo intégré évolutif et la communication par chat ainsi que d'autres fonctionnalités disponibles uniquement sous une forme très limitée dans le cas d'une licence gratuite. Et nous pouvons développer d'autres intégrations et capacités dont vous avez besoin.",
    "A subscription helps you get the most out of Nextcloud! Don't your users deserve the best?" : "Un abonnement vous aide à tirer le meilleur parti de Nextcloud ! Vos utilisateurs ne méritent-ils pas ce qu'il y a de mieux ?",
    ...
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact you Nextcloud account manager to get your subscription updated!" : "Votre abonnement Nextcloud ne couvre plus le nombre d'utilisateur qui sont actuellement actifs sur votre serveur. Merci de contacter votre gestionnaire de compte Nextcloud pour mettre à niveau votre abonnement !",
    ...
    "Your Nextcloud server Subscription is expired!" : "Votre abonnement Nextcloud est expiré !",
    "Your Nextcloud Subscription has expired! Please contact you Nextcloud account manager to get your subscription updated!" : "Votre abonnement Nextcloud a expiré ! Merci de contacter votre gestionnaire de compte Nextcloud pour mettre à jour votre abonnement !",
