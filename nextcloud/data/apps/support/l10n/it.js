OC.L10N.register(
    ...
    "A Nextcloud Support Subscription means the original developers behind your private cloud server are 100% dedicated to your success: the security, scalability, performance and functionality of your service!" : "Una sottoscrizione di supporto di Nextcloud significa che gli sviluppatori originali dietro il server di cloud privato sono dedicati al 100% al tuo successo: la sicurezza, la scalabilità, le prestazioni e la funzionalità del tuo servizio!",
    "If you encounter a problem and your server does no longer work, blocking employees from sharing or customers from downloading and uploading files, you don't have to rely on searching online and asking volunteers on forums and social media for a solution. You have direct access to our experienced engineers who help you track down and fix the problem." : "Se si verifica un problema e il tuo server non funziona più, bloccando la condivisione tra gli impiegati o lo scaricamento o il caricamento dei file da parte dei clienti, non devi affidarti alle ricerche in linea o a chiedere una soluzione a volontari sui forum o sulle reti sociali. Hai accesso diretto ai nostri ingegneri esperti che ti aiuteranno a individuare e correggere il problema.",
    "You have a contract with the vendor providing confidential security information, mitigations, patches and updates." : "Hai un contratto con il venditore che fornisce informazioni di sicurezza confidenziali, mitigazioni, patch e aggiornamenti.",
    "If you want to skip a release or two and stay a bit longer on your current version without disruptions, you don't have to run software without security updates. We deliver them to you as long as is needed!" : "Se vuoi saltare un rilascio o due e rimanere per un po' con la tua versione attuale senza interruzioni, non devi eseguire software senza aggiornamenti di sicurezza. Ti consegneremo tali aggiornamenti fino a quando è necessario.",
    "If you have performance and scalability issues you have the best expertise at hand, instead of having to search on the web and hope you find a solution." : "Se hai problemi di prestazioni e scalabilità, hai le migliori esperienze a portata di mano, invece di dover cercare sul web e sperare di trovare una soluzione.",
    "If you are asked how the compliance of Nextcloud is and if you can deliver a data export under GDPR, HIPAA or other rules, you have access to the right documentation and can tap into our expertise to respond quickly and accurately." : "Se ti viene chiesto quale sia il livello di conformità di Nextcloud e se puoi consegnare un'esportazione di dati sotto GDPR, HIPAA o altre regolamentazioni, devi accedere alla giusta documentazione e puoi sfruttare la nostra esperienza per rispondere rapidamente e accuratamente.",
    "We can also provide you Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a very limited form for free. And we can develop further integrations and capabilities you need." : "Possiamo inoltre fornirti integrazione con Outlook, Office online, comunicazioni audio-video e chat integrata scalabile e altre funzionalità disponibili solo in forma molto limitata gratuitamente. Possiamo sviluppare ulteriori integrazioni e capacità che potrebbero servirti.",
    "A subscription helps you get the most out of Nextcloud! Don't your users deserve the best?" : "Una sottoscrizione ti aiuta a ottenere il massimo da Nextcloud! Non pensi che i tuoi utenti meritino il meglio?",
    ...
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact you Nextcloud account manager to get your subscription updated!" : "La tua sottoscrizione Nextcloud non copre il numero di utenti che sono attualmente attivi su questo server. Contatta il tuo account manager di Nextcloud e aggiorna la tua sottoscrizione!",
    ...
    "Your Nextcloud server Subscription is expired!" : "La sottoscrizione del tuo server Nextcloud è scaduta!",
    "Your Nextcloud Subscription has expired! Please contact you Nextcloud account manager to get your subscription updated!" : "La tua sottoscrizione di Nextcloud è scaduta! Contatta il tuo account manager di Nextcloud per aggiornare la tua sottoscrizione!",
    "Support" : "Supporto",
