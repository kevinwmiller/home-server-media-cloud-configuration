OC.L10N.register(
    ...
    "If you want to skip a release or two and stay a bit longer on your current version without disruptions, you don't have to run software without security updates. We deliver them to you as long as is needed!" : "Si quieres saltarte una versión o dos y permanecer un poco más en tu versión actual sin disrupciones, no tienes que ejecutar software sin actualizaciones de seguridad. Te las entregamos durante tanto tiempo como haga falta.",
    "If you have performance and scalability issues you have the best expertise at hand, instead of having to search on the web and hope you find a solution." : "Si tienes problemas de rendimiento y escalabilidad, tienes la máxima experiencia al alcance, en lugar de tener que buscar en la web y esperar hayar una solución.",
    "If you are asked how the compliance of Nextcloud is and if you can deliver a data export under GDPR, HIPAA or other rules, you have access to the right documentation and can tap into our expertise to respond quickly and accurately." : "Si se te pregunta cómo es el cumplimiento de Nextcloud y si puedes entregar una exportación de atos bajo GDPR, HIPAA u otras reglas, tienes acceso a la documentación correcta y puedes contactar con nosotros para responder rápida y acertadamente.",
    "We can also provide you Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a very limited form for free. And we can develop further integrations and capabilities you need." : "También ofrecemos integración con Outlook, ofimática online, comunicación de audio, vídeo y escrita integrada y escalable y otras características, solo disponibles de forma muy límitada, de forma gratuita. Y podemos desarrollar más integraciones y capacidades que necesites.",
    "A subscription helps you get the most out of Nextcloud! Don't your users deserve the best?" : "Una suscripción te ayuda a conseguir lo mejor de Nextcloud. ¿No merecéis los usuarios lo mejor?",
    ...
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact you Nextcloud account manager to get your subscription updated!" : "Tu suscripción de Nextcloud no cubre el número de usuarios que están actualmente activos en este servidor. Por favor, contacta con tu gestor de cuenta de Nextcloud para actualizar tu suscripción.",
    ...
    "Your Nextcloud Subscription has expired! Please contact you Nextcloud account manager to get your subscription updated!" : "¡Tu suscripción de Nextcloud ha expirado! Por favor, contacta tu gestor de cuenta de Nextcloud para actualizar tu suscripción.",
    "Support" : "Soporte",
