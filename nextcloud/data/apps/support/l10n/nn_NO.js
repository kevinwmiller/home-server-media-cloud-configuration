OC.L10N.register(
    ...
    "A Nextcloud Support Subscription means the original developers behind your private cloud server are 100% dedicated to your success: the security, scalability, performance and functionality of your service!" : "Eit Nextclout brukarstøtte abonnement betyr at opprinneleg utviklarar bak din private sky tenar er 100% dedikert til din suksess: tryggleik, skalerbarheit, yting og funksjonalitet for di teneste.",
    "If you encounter a problem and your server does no longer work, blocking employees from sharing or customers from downloading and uploading files, you don't have to rely on searching online and asking volunteers on forums and social media for a solution. You have direct access to our experienced engineers who help you track down and fix the problem." : "Hvis du støyter på eit problem, og tenaren din ikkje lenger fungerer, blokkerer ansatte frå å dele eller kunder frå å laste ned og laste opp filer, treng du ikkje å lite på å søke på internett og spørje frivillige på forum og sosiale medier for ei løysing. Du har direkte tilgang til våre erfarne ingeniører som hjelp deg med å spore opp og løyse problemet.",
    "You have a contract with the vendor providing confidential security information, mitigations, patches and updates." : "Du har ei kontrakt med leverandør som gir konfidensiell sikkerhetsinformasjon, begrensningar, rettingar og oppdateringar.",
    "If you want to skip a release or two and stay a bit longer on your current version without disruptions, you don't have to run software without security updates. We deliver them to you as long as is needed!" : "Om du vil stå over ei utgåve eller to og halde lenger på din noverande versjon utan forstyrringar, trenger du ikkje installere programvare utanom tryggleiksoppdateringer. Vi leverer desse til deg så lenge det er nødvendig!",
    "If you have performance and scalability issues you have the best expertise at hand, instead of having to search on the web and hope you find a solution." : "Hvis du har problem med yting enn skalering, har du den beste ekspertisen på plass, i stadet for å søke på nettet for å finne ei løysing.",
    "If you are asked how the compliance of Nextcloud is and if you can deliver a data export under GDPR, HIPAA or other rules, you have access to the right documentation and can tap into our expertise to respond quickly and accurately." : "Hvis du blir spurt om Nextcloud er i samsvar med eller kan levere dataeksport etter reglane i GDPR, HIPAA eller andre, har du tilgang til den rette dokumentasjonen og kan få tak i vår kunnskap for å reagere raskt og nøyaktig.",
    "We can also provide you Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a very limited form for free. And we can develop further integrations and capabilities you need." : "Vi kan også gje deg Outlook-integrasjon, Online Office, skalerbar integrert lyd, video og lynmeldingar, en annan funksjon berre er tilgjengelig i svært begrenset form gratis. Vi kan utvikle ytterlegare integrasjonar og funksjonar du trenger.",
    "A subscription helps you get the most out of Nextcloud! Don't your users deserve the best?" : "Eit abonnement gjer deg meir ut av Nextcloud! Sikre at dine brukarar får den beste løysinga. ",
    ...
    "Your Nextcloud Subscription doesn't cover the number of users who are currently active on this server. Please contact you Nextcloud account manager to get your subscription updated!" : "Ditt Nextcloud-abonnement dekkjer ikkje antall brukarar som for øyeblikket er aktive på denne tenaren. Ta kontakt med Nextcloud kontoadministrator for å få abonnementet oppdatert!",
    ...
    "Your Nextcloud server Subscription is expired!" : "Ditt Nextcloud tenar abonnement er utgått!",
    "Your Nextcloud Subscription has expired! Please contact you Nextcloud account manager to get your subscription updated!" : "Ditt Nextcloud tenar abonnement er utgått! Ver venleg å kontakt din Nextcloud konto adminstrator for å få abonnement oppdatert!",
    "Support" : "Støtte",
    ...
    "Follow us on Google+" : "Fylj på Google+",
